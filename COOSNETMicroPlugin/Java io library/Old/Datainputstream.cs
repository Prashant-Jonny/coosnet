...
//UPGRADE_TODO: The type 'org.apache.harmony.luni.util.Util' could not be found. If it was not included in the conversion, there may be compiler issues. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1262'"
...
namespace java.io
{
	...
	public class DataInputStream : DataInput
	{
		...
		/// </seealso>
		public DataInputStream(System.IO.Stream in_Renamed):base(in_Renamed)
		{
			buff = new sbyte[8];
		}
		...
		private static System.String decodeUTF(int utfSize, System.IO.BinaryReader in_Renamed)
		{
		...
		//UPGRADE_NOTE: The equivalent of method 'java.io.DataInputStream.readUTF' is not an override method. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1143'"
		//UPGRADE_TODO: Interface 'java.io.DataInput' was converted to 'System.IO.BinaryReader' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaioDataInput'"
		public static System.String readUTF(System.IO.BinaryReader in_Renamed)
		{
