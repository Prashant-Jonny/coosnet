    ...
    
{
       public static string DEFAULT_QOS_CLASS = "defaultQos";
        ...
        /// <summary>
         ///The costmap of this link, key is QoS, value cost
        /// </summary>
        ...
        /// <returns> the costMap
        /// </returns>
        public System.Collections.Hashtable CostMap
        {
            get
            {
                return costMap;
        ...
        {
            get { 
                if (costMap.Contains(DEFAULT_QOS_CLASS)) 
        ...
        protected ILog log = LogFactory.getLog("Link");
         ...
         public Link(int cost) : this() {
          ...
          costMap.Add(DEFAULT_QOS_CLASS,cost);
         }
...
#if KEEP_JAVA_GET_SET
         public ArrayList getFilterProcessors()
         {
             return filterProcessors;
         }
	     ...
	     public void start()  {
             ...
             if (origCostMap == null) {
                 ...
                 foreach (string key in origCostMap.Keys)
                     costMap.Add(key, (int)origCostMap[key]);
