...
namespace Org.Coos.Messaging
{
    ...
    ///<summary>The Plugin, A holder class for all information associated with a plugin</summary>
    ...
    public class Plugin
    {
        ...
        /// </summary>
        /// <exception cref="ConnectingException">Thrown if any of the channels fails in connecting</exception>
        public void connect()
        {
        ...
        /// <exception cref="ConnectingException">thrown if the channel fail in connecting</exception>
        ...
        ///<summary>Shuts down a specific channel. Does not bring down the endpoint</summary>
        ...
        ///<summary>
        ///Shuts down all channels connected to this endpoint. Shuts down the endpoint
        ///</summary>
