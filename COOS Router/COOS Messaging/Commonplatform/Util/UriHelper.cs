...
///<summary>Helper class for parsing URIs</summary>
///<author>Knut Eilif Husa, Tellu AS</author>
public class URIHelper {

    private readonly string coosProtocol = "coos://";
	...
	public URIHelper(string endpointUri)  {
		...
		int i = endpointUri.IndexOf(coosProtocol);
		if (i == -1) {
			throw new System.ArgumentException("Unknown protocol for uri: " + endpointUri +" expected: "+coosProtocol);
		}
